 ...
 *    
 *    $Id: InsertParagraphAfterAction.java 646 2013-06-26 11:03:23Z mzampare $
 *
*/
...
public class InsertParagraphAfterAction extends CreateParagraphAction {
	
	public InsertParagraphAfterAction() {
		super();
		setName("Insert Paragraph After");
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (userObject instanceof Element) {
			...
			super.addParagraph(tree, father,el);
